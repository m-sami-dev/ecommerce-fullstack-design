...
# # --- Database -----------------------------------------------------------
# # Uses PostgreSQL. Create the database first (see backend/README.md),
# # then set the values below in your .env file.
# DATABASES = {
#     'default': {
...
# --- Email ----------------------------------------------------------------
# By default, emails print to the terminal (free, no setup needed for testing).
# Once you have a Gmail App Password, set EMAIL_BACKEND=smtp in your .env.
